...
public class BigOh
{
    ...
    {
        // TODO
        double min = timeAlgorithm(choice, n);
        for (int i = 0; i < 4; i++)
        {
    ...
    public double timeAlgorithm(int choice, int n)
    {
        ...
        // TODO
        return (seconds2 - seconds) / MILLISECONDS_PER_SECOND;
    }
    ...
    {
        // TODO
        double percent = (estimate - correct) / correct;
        return percent;
    }
    ...
    public double computePercentError(int choice, int n1, int n2)
    {
        // TODO
        double percent = 0.0;
        double robust = robustTimeAlgorithm(choice, n1);
        double robust2 = robustTimeAlgorithm(choice, n2);
        double est = estimateTiming(choice, n1, robust, n2);
        percent = percentError(robust2, est);
        return percent;
    }
